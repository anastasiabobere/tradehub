...
//   const userId = firebase.auth().currentUser.uid; // Get current logged-in user ID
//   const chatsRef = firebase.database().ref("chats");
...
//     const chatListElement = document.getElementById("chatList"); // Assume you have a div with id="chatList" in profile.html
...
//       // Check if the current user is either the sender or a participant in the chat
//       if (
//         lastMessage &&
//         (lastMessage.senderId === userId || chatId.includes(userId))
//       ) {
//         // Get the other user ID in the chat (for display purposes)
//         const participants = chatId.split("_");
//         const otherUserId = participants.find(
//           (participant) => participant !== userId,
//         );
